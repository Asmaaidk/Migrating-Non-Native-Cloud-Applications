...
| ------------ | ------------ | ------------ |
| *Azure Postgres Database* | General purpose Gen 5, 2 vCore     |    $138.47          |
| *Azure Service Bus*   |    Standered     |     $9.81        |
| *Azure App Service Plan* | P1V2 | $75.92 |
| *Azure Function App* | (same Server Plan) | ---  |
